...
from scaffold.graph.primitives.flow_edge import FlowEdge
...
class FlowGraph[W: Weight](_AbstractGraph[FlowEdge[W]]):
    ...
    def __iadd__(self, other: object) -> FlowGraph[W]:
        ...
        from scaffold.graph.primitives.flow_edge import FlowEdge as _FlowEdge
    ...
    def to_edge_list(self) -> list[tuple[Vertex, Vertex, W]]:
        """정방향 간선을 ``(u, v, capacity)`` 튜플 목록으로 반환한다."""
        return [
