...
from scaffold.graph.primitives.endpoints import HasEndpoints

if TYPE_CHECKING:
    from scaffold.graph.primitives.edge import Edge, WeightedEdge
    from scaffold.graph.primitives.vertex import Vertex
    from scaffold.graph.walk import Walk, WeightedWalk
